  ...
  work: [
    {
      ...
      description: [
        "Served as a tutor for a coding boot-camp, teaching JavaScript and React and node to aspiring developers. Providing hands-on guidance, explained complex concepts in a clear and approachable way, and supported students in building practical, real-world projects to enhance their skills and confidence.",
        "Developed full-stack React applications, adhering to industry best practices for high-quality code, utilizing libraries such as Mongoose, React, Tailwind and Redux.",
      ],
    },
    {
      ...
      description: [
        "Lead front-end developer for a startup building the next gen E-learning experience.",
        "Developer for a dynamic mentorship platform designed to connect individuals with experienced mentors who provide personalized guidance, support, and inspiration.",
        "Developer for an inclusive and supportive mental health platform.",
